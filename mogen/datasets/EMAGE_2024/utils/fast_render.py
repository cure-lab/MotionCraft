...
def generate_silent_videos(render_video_fps, 
    ...
    mogen.datasets.EMAGE_2024.utils.media.convert_img_to_mp4(os.path.join(output_dir, f"frame_%d.{render_tmp_img_filetype}"), output_file, render_video_fps)
