...
from .mcm import DecoderLayer, MCMTransformer
...
class ControlT2MBlock(Module):
    def __init__(self, base_block: DecoderLayer, block_index: 0, latent_dim: 512, cfg: None) -> None:
        ...
        self.copied_block = DecoderLayer(
            sa_block_cfg=cfg.model.model['sa_block_cfg'],
            ca_block_cfg=cfg.model.model['ca_block_cfg'],
...
class ControlT2MHalf_MCM(Module):
    
    def __init__(self, base_model: MCMTransformer, copy_blocks_num: int = 2, control_cond_feats: int = 438, cfg: dict = {}) -> None:
    ...
    def forward(self,
        ...
        """
        Forward pass of MCMTransformer.
